    ...
    template: `
        <div class="topbar clearfix">
            ...
            <div class="topbar-right">
                <a id="menu-button" href="#" (click)="app.onMenuButtonClick($event)" [ngClass]="{'menu-button-rotate': rotateMenuButton}">
                    <i></i>
                </a>
                ...
                <ul class="topbar-items animated fadeInDown" [ngClass]="{'topbar-items-visible': topbarMenuActive}">
                    <li #profile class="profile-item" [hidden]="profileMode!='top'&&layoutMode!='horizontal'"
